            ...
            <form @submit.prevent="submit" class="w-96 mx-auto bg-white p-5 rounded-lg max-[500px]:w-full">
                ...
                <div v-else class="block mt-4">
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-sm text-gray-600">By clicking "Create account" or "Countinue with Google", you agree to the 
                            <a target="_blank" :href="null" class="underline text-sm text-gray-600 hover:text-gray-900">Fittr TOS</a> and 
                            <a target="_blank" :href="null" class="underline text-sm text-gray-600 hover:text-gray-900">Privacy Policy</a>.</span>
                    </label>
                </div>
                ...
                <ButtonLink class="mt-4 w-full justify-center" :href="route('login')">
                    Log in
                </ButtonLink>
            </form>
        </AuthenticationCard>
