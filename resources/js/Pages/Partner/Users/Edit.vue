...
const newPasswordLabel = computed(() => (showPasswordField.value ? "Keep current password" : "Set new password"));
...
<template>
    <FormSection @submitted="updateUser">
        ...
        <template #form>
            ...
            <template v-if="$page.props.user.id != form.id">
                ...
                <div class="col-span-6 sm:col-span-4" v-if="!form.is_super">
                    <div v-if="!props.roles.length">
                        You don't have any roles, please create new role and come back
                        <ButtonLink :href="route('partner.roles.create')" type="primary">Add new</ButtonLink>
                    </div>
                    <div v-else>
            ...
            <div class="col-span-6 sm:col-span-4">
                <InputLabel @click="showPasswordField = !showPasswordField" for="password" :value="newPasswordLabel" class="cursor-pointer" />
