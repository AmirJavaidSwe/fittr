     ...
     <Section bg="bg-white space-y-4">
        ...
        <!-- <CardIcon :card-link="route('partner.settings.payments.stripe')"></CardIcon> -->
            ...
            <div>
                ...
                <div class="bg-white rounded bg-white bg-white-50 hover:bg-white-100 items-center p-3 pt-5 gap-4 relative transition rounded">
                    <h3 class="text-2xl"><strong>Stripe Connect</strong></h3>
                     <p class="text-base">Connect your Stripe merchant account to let Appointment thing charge your customers as appointments are scheduled.</p>
            ...
            <div class="block h-px mt-4 mb-4 bg-gray-200 border-0 dark:bg-gray-700"></div>
                <div class="flex flex-col">
                    <h3 class="text-lg"><strong>Connect your Stripe Account.</strong></h3>
                    <p class="text-gray-400 mt-2"><span class="mr-2 border-l-4 border-[#315D3F] rounded-md border-t-[4px]"></span>Allows your to accept Stripe Payments for appointments. 
                       <button class="mt-[-23px] float-right inline-flex items-center disabled:opacity-25 transition font-semibold bg-secondary-500 hover:bg-secondary-100 focus:bg-secondary-100 active:bg-secondary-600 text-dark active:text-white rounded-md border border-secondary-500 hover:bg-secondary-100 hover:text-secondary-500 hover:shadow-md hover:shadow-secondary-200 focus:shadow-md focus:text-secondary-500 focus:shadow-secondary-100 active:shadow-none px-4 h-11 text-sm"> 
                                <svg class="mr-1" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M17.2793 10.45L20.9993 6.72998L17.2793 3.01001" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div class="mt-2 bg-white rounded pt-5 flex gap-4 md:flex-col lg:flex-row sm:flex-col">
            <div class="bg-gray-100 p-5 rounded">
                ...
                <div class="flex">
                    ...
                    <div class="flex flex-col ml-4">
                        <span>
                        <svg width="100%" height="44" viewBox="0 0 156 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M2.55469 42L29.0181 31L52.6461 41L78.1644 4L102.738 20L127.311 9L152.829 42" stroke="#315D3F" stroke-width="1.5"/>
                        </svg>
                        </span>
                    </div>
                </div>
