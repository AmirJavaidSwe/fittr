    ...
    <div class="text-xl font-bold tracking-tight text-gray-900">
     ...
     <Section bg="bg-white space-y-4">
        ...
        <CardIcon icon-class="self-start">
            ...
            <template #default>
                Run email campaigns for your customers. Everytime new user signs up, we will send a contact information to your Mailchimp account.
                <div class="mt-4">
                    <label class="flex items-center">
                        <Checkbox v-model:checked="form.integration_mailchimp_status" :value="form.integration_mailchimp_status ? '1' : '0'" />
                        <span class="ml-4 text-sm text-gray-700">Enable</span>
                    </label>
                    <InputError :message="form.errors.integration_mailchimp_status" class="mt-2" />
                </div>
                <div v-if="form.integration_mailchimp_status" class="mt-4 space-y-4">
                    <div>
                        <InputLabel for="integration_mailchimp_api_key" value="API Key" />
                        <div class="text-sm text-gray-600">Create your API key from Extras->API keys</div>
                        <TextInput
                        ...
                        />
                        <InputError :message="form.errors.integration_mailchimp_api_key" class="mt-2" />
                    </div>
                    <div>
                        <InputLabel for="integration_mailchimp_list_id" value="Audience/List ID" />
                        <div class="text-sm text-gray-600">Copy your Audience ID from Settings->Audience names and defaults</div>
                        <TextInput
                            ...
                            class="mt-1 block w-full"
                        />
                        <InputError :message="form.errors.integration_mailchimp_list_id" class="mt-2" />
                    </div>
                </div>
            </template>
        </CardIcon>
        ...
        <CardIcon icon-class="self-start">
            ...
            <template #default>
                Run email campaigns for your customers. Everytime new user signs up, we will send a contact information to your Sendgrid account.
                <div class="mt-4">
                    <label class="flex items-center">
                ...
                <div v-if="form.integration_sendgrid_status" class="mt-4 space-y-4">
                    <div>
                        <InputLabel for="integration_sendgrid_api_key" value="API Key" />
                        <div class="text-sm text-gray-600">
                            Create new restricted API key under Settings->API keys.<br>
                            On Access Details list, expand Marketing and set access permission to Full access.<br>
                        ...
                        <TextInput
                            ...
                            class="mt-1 block w-full"
                        />
                        <InputError :message="form.errors.integration_sendgrid_api_key" class="mt-2" />
                    </div>
                    <div>
                        <InputLabel for="integration_sendgrid_list_id" value="List ID" />
                        <div class="text-sm text-gray-600">
                            Create new list from Marketing->Contacts and copy list ID.<br>
                            List ID has a total of 36 characters (a.k.a UUID), e.g 12345678-abcd-abcd-abcd-1234567890ab<br>
                            Copy your list ID from browser, e.g.: https://mc.sendgrid.com/contacts/lists/<b>12345678-abcd-abcd-abcd-1234567890ab</b>
                        </div>
                        <TextInput
                            id="integration_mailchimp_list_id"
                            ...
                            class="mt-1 block w-full"
                        />
                        <InputError :message="form.errors.integration_sendgrid_list_id" class="mt-2" />
                    </div>
                </div>
            </template>
        </CardIcon>
        ...
        <CardIcon icon-class="self-start">
            ...
            <template #default>
                Run email campaigns for your customers. Everytime new user signs up, we will send a contact information to your Sendinblue account.
                <div class="mt-4">
                    <label class="flex items-center">
                ...
                <div v-if="form.integration_sendinblue_status" class="mt-4 space-y-4">
                    <div>
