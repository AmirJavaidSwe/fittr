...
<template>
    <form @submit.prevent="submitForm" class="">
        <div class="p-3 pt-3 gap-4 relative transition rounded mt-4">
            <div class="text-2xl font-bold tracking-tight text-gray-900 pt-2 pb-4">
                Marketing
            </div>
            <div class="md:px-10 mt-4">
                <div class="py-6 border-b border-slate-500">
                    <div class="flex flex-wrap justify-between items-center pb-4">
                        <MailchimpIcon class="w-40 py-4" />
                    </div>
                    <div class="mt-2">
                        <ButtonLink
                            styling="secondary"
                            size="default"
                            @click="form.integration_mailchimp_status = !form.integration_mailchimp_status"
                        >
                            <span v-if="!form.integration_mailchimp_status">Enable</span>
                            <span v-else>Disable</span>

                        </ButtonLink>
                    </div>
                    <div class="w-full md:w-[60%] pt-5">
                        <p>
                    ...
                    <div class="grid gap-4 grid-cols-2 mt-5 mb-4" v-if="form.integration_mailchimp_status">
                        <div class="grow-none">
                ...
                <div class="py-6 border-b border-slate-500">
                    <div class="flex flex-wrap justify-between items-center">
                        <SendGridIcon class="w-40" />
                    </div>
                    <div class="mt-2">
                        <ButtonLink
                            styling="secondary"
                            size="default"
                            @click="form.integration_sendgrid_status = !form.integration_sendgrid_status"
                        >
                            <span v-if="!form.integration_sendgrid_status">Enable</span>
                            <span v-else>Disable</span>
                ...
                <div class="py-6 border-b border-slate-500">
                    <div class="flex flex-wrap justify-between items-center pb-4">
                        <BrevoIcon class="w-36 py-4" />
                    </div>
                    <div class="mt-2">
                        <ButtonLink
                            styling="secondary"
                            size="default"
                            @click="form.integration_sendinblue_status = !form.integration_sendinblue_status"
                        >
                            <span v-if="!form.integration_sendinblue_status">Enable</span>
                            <span v-else>Disable</span>
                    ...
                    <div class="w-full md:w-[60%] pt-5">
                        <p>
                            Run email campaigns for your customers. Everytime new user signs up, we will send a contact information to your Brevo account.
                        </p>
                    </div>
                ...
                <!--sendinblue-->
                <div
                    class="flex items-center justify-end px-4 py-6 text-right sm:px-6"
                >
