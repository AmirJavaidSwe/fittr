...
const meta_title = computed(() => {
    ...
    return form.meta_title ? 
        (over ? form.meta_title.substring(0, 60) + '...' : form.meta_title) :
...
const meta_description = computed(() => {
    ...
    return form.meta_description ? 
        (over ? form.meta_description.substring(0, 160) + '...' : form.meta_description) : 
    ...
    <FormSection @submitted="submitForm">
        ...
        <template #form>
                ...
                <CardBasic class="my-4">
                    ...
                    <div>
                        <div class="flex items-center gap-2 mb-2">
                            <span class="w-7 h-7">
                                <img src="https://ui-avatars.com/api/?background=0D8ABC&color=fff" alt="favicon">
                            </span>
                            <div>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                />
                <div v-if="form.meta_title" class="text-sm">Chars: {{form.meta_title.length}}</div>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                />
                <div v-if="form.meta_description" class="text-sm">Chars: {{form.meta_description.length}}</div>
