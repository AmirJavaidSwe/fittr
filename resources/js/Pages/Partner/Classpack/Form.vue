...
<template>
    <FormSection @submitted="submitted">
        <template #form>
            ...
            <div class="">
                <InputLabel for="sessions" value="Number of sessions in one classpack"/>
                <TextInput
                    id="sessions"
            ...
            <div class="">
                <Switcher
                    ...
                    :description="'Pack sessions ' + (form.is_expiring ? 'will' : 'never') + ' expire'"/>
            ...
            <div v-if="form.is_expiring" class="">
                ...
                <div class="flex mt-1 gap-2">
                    <TextInput
                        ...
                        />
                    <!-- <div> -->
                        <RadioGroup v-model="form.expiration_period" class="flex cursor-pointer rounded-lg shadow-md">
                            <RadioGroupOption 
                            as="template"
                    ...
                    <InputError :message="form.errors.expiration_period" class="mt-2"/>
            ...
            <div class="">
                <Switcher
                    ...
                    title="Status"
                    :description="'Pack is ' + (form.is_active ? 'active' : 'inactive')"/>
            ...
            <div class="">
                <Switcher
                    ...
                    @update:modelValue="checkToggles('is_renewable', form.is_renewable)"
                    title="Renewable"
                    :description="'Pack is ' + (form.is_renewable ? '' : 'not ') + 'renewable'"/>
            ...
            <div class="">
                <Switcher
                    ...
                    title="Intro pack"
                    :description="'Pack available to ' + (form.is_intro ? 'new members only' : 'anyone')"/>
