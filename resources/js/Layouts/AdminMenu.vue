...
<template>
    <div class="flex-grow p-4 bg-primary-500 overflow-y-auto space-y-4">
        ...
        <NavLink
            ...
            :active="active_route.name == 'admin.partners.performance.index'"
            v-can="{
                module: 'partners-performance',
                roles: $page.props.user.user_roles,
                permission: 'viewAny',
                user: $page.props.user,
            }"
        ...
        <NavLink
            ...
            :active="active_route.name == 'admin.partners.index'"
            v-can="{
        ...
        <NavLink
            ...
            :active="active_route.name == 'admin.instances.index'"
            v-can="{
        ...
        <NavLink
            ...
            :active="active_route.name == 'admin.settings'"
            v-can="{
                module: 'settings',
                roles: $page.props.user.user_roles,
                permission: 'viewAny',
        ...
        <NavLink
            ...
            :active="
                active_route.name == `${$page.props.user.source}.roles.index`
            "
            v-can="{
                module: 'roles',
                roles: $page.props.user.user_roles,
