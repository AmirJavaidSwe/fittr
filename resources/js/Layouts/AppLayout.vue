            ...
            <div class="h-screen">
                <div class="flex h-full relative">
                    ...
                    <div
                        ...
                        :class="{
                            '-translate-x-full md:translate-x-0 md:-ml-56': sidebarCollapsed,
                        }"
                    >
                        <div class="w-56 h-full bg-primary-500">
                            <div class="flex items-center flex-shrink-0">
                                <!-- Logo -->
                                <div class="relative w-full px-6 py-4">
                                    <Link :href="route($page.props.user.dashboard_route)">
                                        <LogoLetter
                                            class="h-12"
                                            fill="#fff"
                                        />
                    ...
                    <div class="flex flex-col flex-1 overflow-hidden md:relative md:z-10 h-full md:h-auto">
                            ...
                            <header class="bg-primary-500 md:bg-white flex items-center justify-between md:px-6 md:py-5 md:text-md p-4 shadow text-sm w-full gap-4 relative">
                                <div class="flex items-center">
                                    ...
                                    <div class="max-w-7xl mx-auto">
                                        <h2 class="font-semibold text-base md:text-xl text-white md:text-gray-800 leading-tight">
                                            <div
                                                v-if="headerIsArray"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="relative flex-shrink-0">
                                        ...
                                        >
                                            <template #trigger>
                                                <div v-if="$page.props.jetstream.managesProfilePhotos" class="flex items-center justify-center">
                                                    <div class="pr-4 text-right">
                                                        <div class="font-bold text-white md:text-dark">
                                            ...
                                            <template #content>
                                                <div
                                                    class="px-4 py-2 border-b bg-gray-50 md:hidden"
                                                >
                                                    <div class="font-bold">
                                                        {{ $page.props.user.name }}
                                                    </div>
